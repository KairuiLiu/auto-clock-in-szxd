...
4. 打开`/.github/workflows/main.yml`, 解除3-4行注释, 默认是在09:31与21:31执行打卡与查寝, 如需修改请修改第4行CRON表达式, **设置时间时需使用UTC时间. 同时, [Github Actions 的定时任务存在延迟](https://docs.github.com/en/actions/using-workflows/events-that-trigger-workflows#schedule), 请适当调整打卡时间**
